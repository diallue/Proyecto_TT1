...
int main() {
    ...
    Matrix Y = DEInteg(Accel, 0, -(Mjd_UTC - Mjd0) * 86400.0, 1e-10, 1e-6, 6, Y0_apr);
    ...
    for (int i = 1; i <= 46; i++) {
        ...
        yPhi = DEInteg(VarEqn, 0, t - t_old, 1e-10, 1e-6, 42, yPhi);
        ...
        Y = DEInteg(Accel, 0, t - t_old, 1e-10, 1e-6, 6, Y_old);
    ...
    Matrix Y0 = DEInteg(Accel, 0, -(obs(46, 1) - obs(1, 1)) * 86400.0, 1e-10, 1e-6, 6, Y);
    ...
    std::cout << "dX " << std::setw(10) << std::fixed << std::setprecision(1) 
              << Y0(1, 1) - Y_true(1, 1) << " [m]\n";
    std::cout << "dY " << std::setw(10) << std::fixed << std::setprecision(1) 
              << Y0(2, 1) - Y_true(2, 1) << " [m]\n";
    std::cout << "dZ " << std::setw(10) << std::fixed << std::setprecision(1) 
              << Y0(3, 1) - Y_true(3, 1) << " [m]\n";
    std::cout << "\nError de Estimación de Velocidad\n";
    std::cout << "dVx " << std::setw(8) << std::fixed << std::setprecision(1) 
              << Y0(4, 1) - Y_true(4, 1) << " [m/s]\n";
    std::cout << "dVy " << std::setw(8) << std::fixed << std::setprecision(1) 
              << Y0(5, 1) - Y_true(5, 1) << " [m/s]\n";
    std::cout << "dVz " << std::setw(8) << std::fixed << std::setprecision(1) 
              << Y0(6, 1) - Y_true(6, 1) << " [m/s]\n";
